    ...
    <main className="min-h-screen bg-white text-slate-900">
      <div className="mx-auto flex max-w-5xl flex-col gap-8 px-6 py-16">
        <header className="flex flex-col gap-3">
          ...
          <p className="max-w-2xl text-lg text-slate-600">Understand how we collect data, protect privacy, and secure infrastructure.</p>
        </header>
        <section className="rounded-3xl border border-slate-200 p-6">
          <h2 className="text-lg font-semibold">What you&apos;ll find here</h2>
          <ul className="mt-3 space-y-2 text-sm text-slate-600">
            <li>Data minimization and masking.</li>
            <li>Encryption in transit and at rest.</li>
            <li>Compliance roadmap and policies.</li>
          </ul>
        </section>
      </div>
    </main>
